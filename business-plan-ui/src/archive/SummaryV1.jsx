          ...
          <tbody>
            ...
            <tr>
              ...
              <td style={{ padding: '0.6rem 0.8rem', fontSize: '0.88rem', lineHeight: '1.7' }}>
                ...
                <div>• <strong>[접근성]</strong> 파운데이션 모델(Foundation Model) 기반 최신 기술 진입 장벽을 낮추는 <strong>연구자 친화적 시각화 제어 화면</strong> 제공</div>
                <div>• <strong>[보안성]</strong> 클라우드 사용 시의 기밀 데이터 보안 문제를 원천 차단하는 <strong>웹 기반 시각화 제어 화면(클라우드 서비스(웹)) 및 폐쇄형 자체 구축형(폐쇄망) 소프트웨어 패키지</strong></div>
            ...
            <tr>
              ...
              <td style={{ padding: '0.6rem 0.8rem', fontSize: '0.88rem', lineHeight: '1.7' }}>
                ...
                <div>• <strong>[보유역량]</strong> 계산화학 도메인 전문성과 인공지능 운영관리 풀스택 개발 역량을 지원하는 <strong>1인 창업자</strong> 주축 + 도메인 특화 <strong>딥테크 AI 연구원</strong> 신규 채용 기반 소수정예 R&D 팀 구성</div>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td style={{ padding: '0.6rem 0.8rem', fontSize: '0.88rem', lineHeight: '1.7' }}>
                ...
                <div>• <strong>▶ 시제품 제작 중</strong> — 클라우드 서비스(웹) 기반 웹 대시보드 형태의 PoC 서비스 릴리즈 준비 중 &amp; B2B 자체 구축형(폐쇄망) 패키징 진행 단계</div>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td style={{ padding: '0.6rem 0.8rem', fontSize: '0.88rem', lineHeight: '1.7' }}>
                <div>• <strong>[단기 전략]</strong> 클라우드 서비스(웹) 기반 PoC 서비스 미끼 상품 전략으로 접근성 향상, 유효 검증 확보</div>
                <div>• <strong>[중장기 전략]</strong> 검증 완료 후 기밀 <strong>데이터 보안이 보장된 자체 구축형(폐쇄망) 솔루션 정식 도입 유도</strong></div>
