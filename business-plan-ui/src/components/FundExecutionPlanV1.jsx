  ...
  return (
    <div className="hwp-section">
      ...
      <p style={{ fontSize: '15.5px', lineHeight: '1.7', marginBottom: '40px', padding: '0 10px' }}>
        본 예비창업패키지 <strong>초기 지원금(1억 원 예상)은 아이템의 치명타인 유해성 리스크를 원천 불식시키는 성적서 획득과, 얼리어답터 확보를 위한 시각적 브랜드(패키징, Web) 고도화 등 가장 투입 가치가 높은 &lt;Value Creating&gt; 항목에 전액 집중 편성</strong>하였습니다.
