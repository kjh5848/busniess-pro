...
const barriers = [
  ...
  { num: '02', title: 'IT 전문인력(MLOps) 부재', desc: '무료 AI 공개되어도 리눅스·GPU 세팅을 생물학 연구원이 병행 불가' },
  { num: '03', title: '데이터 유출(보안) 우려', desc: '신약 기밀 자산을 SaaS 외부 서버에 업로드 → 보수적 제약사 도입 거부' },
...
const valueProps = [
  ...
  { num: '나', title: '온프레미스 망분리', desc: '폐쇄망 완전 독립 구동, 유출 제로(0)' },
