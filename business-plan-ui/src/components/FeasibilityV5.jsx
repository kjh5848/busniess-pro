        ...
        <section>
          ...
          <div className="v2-info-box" style={{ borderLeft: '4px solid #333', marginBottom: '1.5rem', backgroundColor: '#fcfcfc' }}>
            <p style={{ fontWeight: 'bold', margin: '0', fontSize: '1.05rem', wordBreak: 'keep-all', lineHeight: '1.6' }}>
              "천문학적인 서버 인프라 비용 때문에 상위 1%의 글로벌 빅파마만 누리던 초정밀 약물 결합력 예측(FEP) 시뮬레이션을, '연합학습(Federated Learning)' 기반의 분산 처리 기술을 통해 노트북에서도 안전하게 구독할 수 있는 클라우드 SaaS 형태로 보급한다."
            </p>
          </div>
          ...
          <p className="v2-box-desc" style={{ marginBottom: '1rem', wordBreak: 'keep-all', lineHeight: '1.6' }}>
            기존 반복 실험 중심의 한계를 넘어, 컴퓨터 가상 공간(In Silico)에서 3D 물리 기반 예측을 통해 거대 난치성 언드러거블(Undruggable) 표적까지 실제 실험실 수준의 정확도로 스크리닝하여 '설계-합성-테스트' 주기를 수개월에서 주 단위로 획기적으로 단축한다. 
          </p>
          ...
          <div style={{ display: 'flex', gap: '2rem', alignItems: 'center', marginBottom: '2rem' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <p style={{ fontSize: '0.9rem', color: '#4b5563', margin: '0 0 1rem 0', wordBreak: 'keep-all', lineHeight: '1.6' }}>
                언드러거블(Undruggable)로 분류되어 접근이 어려웠던 표적 물질에 대해서도 압도적 속도와 효율로 가능성 높은 화합물을 우선 추려낸다. 이는 수많은 화학 시약 조달 비용(CAPEX)을 아껴줄 뿐만 아니라, 실효성 없는 <strong>전임상 동물 실험 단계의 불필요한 희생을 40% 이상 경감</strong>하는 강력한 ESG 성과를 창출한다.
              </p>
          ...
          <p className="v2-box-desc" style={{ fontWeight: 'bold', marginBottom: '0.5rem', marginTop: '2rem', color: '#2563eb' }}>
            ■ 자체 성능 오차율(1.0 kcal/mol 이하) 목표 검증 및 증빙 계획
          </p>
          <div className="v2-info-box" style={{ flexDirection: 'column', backgroundColor: '#eff6ff', border: '1px solid #bfdbfe' }}>
            <p style={{ margin: 0, fontSize: '0.9rem', color: '#1e3a8a', wordBreak: 'keep-all', lineHeight: '1.6' }}>
              <strong>[후향적 성능 검증(Retrospective Validation) 백서 발간]</strong><br/>
              제안된 FEP 엔진의 신뢰성을 객관적으로 증빙하기 위해, 협약 기간 내 <strong>공개 화합물 데이터셋(PDBbind 등) 1,000종을 활용한 대규모 블라인드 백테스트를 수행</strong>한다. 이를 통해 상용 소프트웨어 대비 오차율 우위(또는 동등성)를 증명하는 성능 검증 백서(Whitepaper)를 글로벌 학회에 발표할 예정이다.
            </p>
          </div>
