          ...
          <tbody>
            ...
            <tr>
              ...
              <td style={{ padding: '0.6rem 0.8rem', fontSize: '0.88rem', lineHeight: '1.7' }}>
                ...
                <div>• <strong>[핵심기능]</strong> AlphaFold·RFdiffusion·DiffDock 등 약물·펩타이드 디자인 오픈소스 AI를 <strong>노코드(코딩 불필요) 원클릭</strong>으로 자동 실행</div>
                <div>• <strong>[핵심기능]</strong> 사내 PC 유휴자원 연계 <strong>그리드 분산연산</strong> → GPU 비용 1/10 절감</div>
                <div>• <strong>[핵심기능]</strong> <strong>자체 구축형 폐쇄망</strong> 배포 → 기밀 연구 데이터 유출 원천 차단</div>
                <div>• <strong>[소비자층]</strong> AI·인공지능 운영관리 전문인력 없는 국내외 벤처·중견 <strong>제약사</strong>(B2B), 대학 연구소·개인 <strong>연구자</strong>(B2C)</div>
            ...
            <tr>
              ...
              <td style={{ padding: '0.6rem 0.8rem', fontSize: '0.88rem', lineHeight: '1.7' }}>
                <div>• 🔒 <strong>보안</strong> — Benchling·Schrödinger 등 경쟁 플랫폼 대비 유일한 자체 구축형 폐쇄망 지원</div>
                <div>• ⚡ <strong>편의</strong> — 코딩 없이 마우스 클릭만으로 AI 파이프라인 구동 (노코드(코딩 불필요) UI), 실험 연구자도 즉시 사용</div>
                <div>• 💰 <strong>가격</strong> — 사내 PC 유휴자원 병렬 처리(Grid)로 클라우드 GPU 대비 연산 비용 1/10 절감</div>
                <div>• <strong>[보유역량]</strong> 대표자 AI·인공지능 운영관리 실무 경력 기반 핵심기술 자체 확보, 글로벌 오픈소스 활용 빠른 개발</div>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td style={{ padding: '0.6rem 0.8rem', fontSize: '0.88rem', lineHeight: '1.7' }}>
                ...
                <div>• <strong>▶ 시제품 제작 중</strong> — B2C 클라우드 버전 선배포 &amp; B2B 자체 구축형(폐쇄망) MVP 개발 진행</div>
              </td>
            </tr>
